...
import type { FilterDefinition } from "../../../../ports/repositories";
import type { RoomId } from "../../../../../fatrix-model/types/matrix";
import { InfraError } from "../../../domain-error";
import type { PartialStatePort } from "../ports/effect-ports";
import type { RoomVisibilityContext } from "../types/contracts";

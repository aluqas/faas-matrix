...
import { sha256, signJson, verifySignature } from "../../../../fatrix-model/utils/crypto";
...
import { validateThirdPartyInviteExchangeRequest } from "../validation";
import {
...
export async function exchangeFederationThirdPartyInvite(input: {
  ...
  const storedPdu: PDU = {
    ...
    auth_events: authEvents,
    prev_events: prevEvents,
    signatures: signedEvent["signatures"] as PDU["signatures"] | undefined,
  };

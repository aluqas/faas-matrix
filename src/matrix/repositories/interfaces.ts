...
export interface SyncRepository {
  ...
  getDeviceListChanges(userId: string, sincePosition: number): Promise<{ changed: string[]; left: string[] }>;
...
export interface FederationRepository {
  ...
  storeCachedTransaction(origin: string, txnId: string, response: Record<string, unknown>): Promise<void>;

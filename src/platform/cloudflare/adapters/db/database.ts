...
import { fanoutEventToRemoteServers } from "../federation/federation-fanout";
import { createFederationOutboundPort } from "../federation/federation-outbound";
 ...
 * Delegates to [`getUserRoomIdsWithEffectiveMembership`](../infra/repositories/membership-repository.ts).
 */
...
export async function getEventsSince(
  ...
  return rows.map((row) => toStoredPdu(row));
}

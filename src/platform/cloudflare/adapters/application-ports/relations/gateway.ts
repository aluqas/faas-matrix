import { federationPost } from "../../federation/federation-keys";
...
import { tryValidateIncomingPdu } from "../../../../../fatrix-backend/application/pdu-validator";
...
export async function fetchFederatedEventRelationshipsResponse(
  env: Pick<import("../../../env").Env, "DB" | "CACHE" | "SERVER_NAME">,

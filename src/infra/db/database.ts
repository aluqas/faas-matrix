...
import { getUserRoomIdsWithEffectiveMembership } from "../../infra/repositories/membership-repository";
import type {
  DeviceId,
  Device,
  Env,
...
import { fanoutEventToRemoteServers } from "../../infra/federation/federation-fanout";

import type { AppEnv, EventId, Membership, RoomId } from "../../shared/types";
import { Errors } from "../../shared/utils/errors";
import { fanoutEventToFederation, notifyUsersOfEvent } from "../../infra/db/database";
import { persistFederationMembershipEvent } from "../../matrix/application/orchestrators/federation-handler-service";
import { requiresFullCreateEventInStrippedState } from "../rooms/room-version-semantics";
import {
  authorizeLocalKnock,
...
import { validateSendKnockRequest } from "../../matrix/application/federation-validation";

...
import {
  PUSH_RULES_ACCOUNT_DATA_TYPE,
  evaluatePushRules,
  getDefaultRulesForUser,
  getUserPushRules,
} from "../fatrix-backend/application/features/push/rules";
import { getAccessTokenRecordByHash } from "../platform/cloudflare/adapters/db/database";
import { notifySyncUser } from "../platform/cloudflare/adapters/realtime/sync-notify";
import {
  type JsonObject,
  type PusherData,
  type PushAction,
...
export async function sendPushNotification(
  ...
  env?: import("../platform/cloudflare/env").Env, // Optional env for direct APNs delivery
): Promise<void> {
...
async function sendDirectAPNs(
  env: import("../platform/cloudflare/env").Env,

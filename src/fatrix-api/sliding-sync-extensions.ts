...
import type { ExtensionsResponse, RoomVisibilityContext } from "../fatrix-model/types/sync";
import type { SlidingSyncExtensionConfig } from "../fatrix-model/types/client";
import type { AccountDataEvent, DeviceId, RoomId, UserId } from "../fatrix-model/types";
import type { ToDeviceEvent } from "../fatrix-model/types/matrix";
import type { Env } from "../platform/cloudflare/env";

import { projectPresenceEvents } from "../fatrix-backend/application/features/presence/project";
import {
  projectGlobalAccountDataSnapshot,
  projectRoomAccountDataSnapshot,
} from "../platform/cloudflare/adapters/application-ports/account-data/projector";
import { projectDeviceLists } from "../fatrix-backend/application/orchestrators/sync-projection";
import { CloudflareSyncRepository } from "../platform/cloudflare/matrix-repositories";
import { getThreadSubscriptionsExtension } from "../platform/cloudflare/adapters/application-ports/sync/thread-subscriptions";
import { getTypingForRooms } from "../platform/cloudflare/adapters/application-ports/typing/project";
import { getReceiptsForRooms } from "../platform/cloudflare/adapters/application-ports/receipts/project";
...
export type { SlidingSyncExtensionConfig };

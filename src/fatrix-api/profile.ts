...
} from "../fatrix-backend/application/features/profile/command";
import {
...
} from "./decoders/profile/decode";
import {
  createProfileCommandPorts,
  createProfileQueryPorts,
} from "../platform/cloudflare/adapters/application-ports/profile/effect-adapters";
import {

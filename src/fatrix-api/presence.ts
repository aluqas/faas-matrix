...
import { setPresenceStatusEffect } from "../fatrix-backend/application/features/presence/command";
import {
  createPresenceCommandPorts,
  createPresenceQueryPorts,
} from "../platform/cloudflare/adapters/application-ports/presence/effect-adapters";
import {
  decodeGetPresenceStatusInput,
  decodeSetPresenceStatusInput,
} from "./decoders/presence/decode";
import { getPresenceStatusEffect } from "../fatrix-backend/application/features/presence/query";
